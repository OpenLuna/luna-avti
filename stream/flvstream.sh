...
# start stream
ffmpeg -an -f video4linux2 -s 640x480 -i /dev/video0 -c:v h264 -an -pix_fmt yuv420p -r 20 $USE_PRESET -tune zerolatency -f flv -metadata streamName=live "tcp://"$STREAM_IP"?pkt_size=1316"
